# batch sampler를 활용하여 지정된 wrong_samples_group 내에서만 mixup, cutmix, mosaic 등을 수행하기 위해 작성하는 코드
...
CFG = {
    ...
    "WORK_DIR": '/project/ahnailab/jys0207/CP/tjrgus5/hecto/work_directories/eva_difficult_example_retraining',
    "START_FROM": '/project/ahnailab/jys0207/CP/tjrgus5/hecto/work_directories/eva_mosaic_mixup_cutmix/best_model_eva02_large_patch14_448.mim_m38m_ft_in1k_fold1.pth', # 만약 None이 아닌 .pth파일 경로 입력하면 해당 checkpoint를 load해서 시작

    # group정보를 담은 json(make_groups.py로 생성) 경로
    "GROUP_PATH": '/project/ahnailab/jys0207/CP/tjrgus5/hecto/work_directories/eva_mosaic_mixup_cutmix/groups.json',
